...
class PolyDrawableTest : public PolyDrawable {
public:
...
{
    PolyDrawable drawable(L"Harold");
    ASSERT_EQ(wxColor(*wxBLACK), drawable.GetColor());

    drawable.SetColor(*wxBLUE);
    ASSERT_EQ(wxColor(*wxBLUE), drawable.GetColor());
