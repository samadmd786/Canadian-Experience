 ...
 */
std::shared_ptr<Actor> SecondHaroldFactory::Create(std::wstring imagesDir)
{

    shared_ptr<Actor> actor = make_shared<Actor>(L"Harold");

    auto shirt = make_shared<ImageDrawable>(L"Shirt", imagesDir+L"/dress.png");
